...
namespace DeviceApp
{
    class Program
    {
        private static DeviceClient deviceClient = DeviceClient.CreateFromConnectionString("HostName=micke-1219.azure-devices.net;DeviceId=DeviceApp;SharedAccessKey=kOkty+axo6R4elfgh8AMwzvFphMZ0a0v5HjCBUr1odU=", TransportType.Mqtt);
